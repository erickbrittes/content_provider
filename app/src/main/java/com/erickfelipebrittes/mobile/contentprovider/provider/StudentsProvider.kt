package com.erickfelipebrittes.mobile.contentprovider.provider
...
class StudentsProvider : ContentProvider() {
    ...
    companion object {
        const val PROVIDER_NAME =
            "com.erickfelipebrittes.mobile.contentprovider.provider.StudentsProvider"
        const val URL =
            "content://$PROVIDER_NAME/students"
